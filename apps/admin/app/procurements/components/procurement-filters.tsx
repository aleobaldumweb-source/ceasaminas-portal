  ...
  return (
    <div className="procurement-filters">
      <label className="filter-field">
        ...
        <input
          className="search"
          placeholder="Número, objeto, descrição ou setor"
          value={props.query}
      ...
      <label className="filter-field">
        ...
        <select
          value={props.status}
          onChange={(event) =>
            props.onStatusChange(event.target.value as 'ALL' | ProcurementStatus)
          }
        >
      ...
      <label className="filter-field">
        ...
        <select
          ...
          onChange={(event) =>
            props.onModalityChange(event.target.value as 'ALL' | ProcurementModality)
          }
        >
      ...
      <label className="filter-field">
        ...
        <select
          ...
          onChange={(event) => props.onPublicationChange(event.target.value as PublicationFilter)}
        >
          <option value="ALL">Todas</option>
      ...
      <label className="filter-field">
        ...
        <select
          value={props.sortKey}
          onChange={(event) => props.onSortKeyChange(event.target.value as SortKey)}
        >
          <option value="deadlineAt">Prazo</option>
          <option value="publishedAt">Publicação</option>
          <option value="number">Número</option>
          <option value="title">Objeto</option>
      ...
      <button type="button" className="secondary clear-filters" onClick={props.onClear}>
        Limpar filtros
      </button>
    </div>
  );
